...
public class ClientUI extends Application {
	 ...
	 * machine ID based on the command line arguments passed in. 
	 * It also adds a shutdown hook to call the ExitHandler.
	 * If no arguments are passed, the system
	 * configuration is set to "OL" and the machine ID is ignored. 
