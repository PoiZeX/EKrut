...
public final class AppConfig {
	...
	// System definition
	public static final String SYSTEM_CONFIGURATION = "OL"; 				// can be changed to OL / EK
	public static int MACHINE_ID = 7; 										// machine id will be dynamically change from arguments
